...
**公開デモ：** [http://ec2-43-206-90-14.ap-northeast-1.compute.amazonaws.com:8501](http://ec2-43-206-90-14.ap-northeast-1.compute.amazonaws.com:8501)
...
基本設定は40人、4学年、各学年10人、各学年2友人グループ、1グループ5人です。UIでは最大200人・5学年まで指定できます。人数が割り切れない設定では、学年と友人グループへできるだけ均等に割り当てます。
...
seed、交流ラウンド数、複数回実験回数は計算には必要ですが、毎回変更する必要はありません。通常は折りたたまれた「実験設定」の初期値（seed 42、5ラウンド、30回実験）のままで十分です。100人以上かつ多数回の実験は計算量が大きくなるため、最初は5～10回で動作を確認することを推奨します。
